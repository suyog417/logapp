...
class ADJChatRoom extends StatefulWidget {
  const ADJChatRoom({Key? key}) : super(key: key);

  @override
  State<ADJChatRoom> createState() => _ADJChatRoomState();
}
...
//   return doc_id2;
// }
class _ADJChatRoomState extends State<ADJChatRoom> {
                    ...
                    onPressed: () {
                      ...
                      if (loginuser!.emailVerified == true) {
                        if (_chatcontroller.text.isNotEmpty) {
                          storemessages.collection("ADJ_Chat").doc().set({
