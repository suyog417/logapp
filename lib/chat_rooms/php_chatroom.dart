...
class PHPChatRoom extends StatefulWidget {
  const PHPChatRoom({Key? key}) : super(key: key);

  @override
  State<PHPChatRoom> createState() => _PHPChatRoomState();
}

class _PHPChatRoomState extends State<PHPChatRoom> {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const ListTile(
          title: Text("PHP Programming ",
              style: TextStyle(
                  fontSize: 18,
                  color: Colors.white,
                  fontWeight: FontWeight.w500)),
          subtitle: Text("Smt. S. B. Wankhede",
              style: TextStyle(
                  fontSize: 13,
                  color: Colors.white,
                  fontWeight: FontWeight.w500)),
                    ...
                    onPressed: () {
                      if (loginuser!.emailVerified == true) {
                        if (_chatcontroller.text.isNotEmpty) {
                          storemessages.collection("PHP_Chat").doc().set({
