...
final lect = FirebaseFirestore.instance.collection("Lectures");
final prac = FirebaseFirestore.instance.collection("Practicals");
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection("/Time_Table/Practicals/Monday")
          .orderBy("start_time", descending: true)
          .snapshots(),
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
